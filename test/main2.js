...
function init() {
  ...
  loader.load("/gltf/demo2.glb", (gltf) => {
    scene.add(gltf.scene);

    // const helper = new WiggleRigHelper({
    //   skeleton: scene.getObjectByName("Box").skeleton,
    // });
    // scene.add(helper);
    ...
    // wiggleBones.push(new WiggleBone(b4, { stiffness: 700, damping: 13 }));
